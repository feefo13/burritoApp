 ...
 */
public class SauceFragment extends Fragment implements View.OnClickListener{
    View v;
    ...
    {
        v = inflater.inflate(R.layout.fragment_ingred_sauce, container, false);

        TextView pintoTextView = (TextView) v.findViewById(R.id.sauce_item1);
        ...
        final CheckBox checkBox2 = (CheckBox) v.findViewById(R.id.sauce_checkBox2);
        final CheckBox checkBox3 = (CheckBox) v.findViewById(R.id.sauce_checkBox3);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.sauce_item1:
                ...
                editor.putInt("sauce", 1);
                editor.commit();
                break;

            case R.id.sauce_item2:
                //mild salsa

                editor.putInt("sauce", 2);
                editor.commit();
                break;

            case R.id.sauce_item5:
                //None

                editor.putInt("sauce", 3);
                editor.commit();
                break;
        }
        editor.putInt("saucep", portionChange);
        editor.commit();
