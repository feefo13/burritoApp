...
public class BeanFragment extends Fragment implements View.OnClickListener{
    ...
    {
        v = inflater.inflate(R.layout.fragment_ingred_bean, container, false);

        TextView pintoTextView = (TextView) v.findViewById(R.id.bean_item1);
        ...
        final CheckBox checkBox2 = (CheckBox) v.findViewById(R.id.bean_checkBox2);
        final CheckBox checkBox3 = (CheckBox) v.findViewById(R.id.bean_checkBox3);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.bean_item1:
                //pinto beans

                editor.putInt("bean", 1);
                editor.commit();
                break;

            case R.id.bean_item2:
                //black beans

                editor.putInt("bean", 2);
                editor.commit();
                break;

            case R.id.bean_item5:
                //None

                editor.putInt("bean", 3);
                editor.commit();
                break;
        }
        editor.putInt("beanp", portionChange);
        editor.commit();
        selectedFragment = new CheeseFragment();
