...
public class RiceFragment extends Fragment implements View.OnClickListener{
    ...
    {
        v = inflater.inflate(R.layout.fragment_ingred_rice, container, false);

        TextView brownTextView = (TextView) v.findViewById(R.id.rice_item1);
        ...
        final CheckBox checkBox2 = (CheckBox) v.findViewById(R.id.rice_checkBox2);
        final CheckBox checkBox3 = (CheckBox) v.findViewById(R.id.rice_checkBox3);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.rice_item1:
                //brown rice

                editor.putInt("rice", 1);
                editor.commit();
                break;

            case R.id.rice_item2:
                //black rice

                editor.putInt("rice", 2);
                editor.commit();
                break;

            case R.id.rice_item5:
                //None

                editor.putInt("rice", 0);
                editor.commit();
                break;
        }
        editor.putInt("ricep", portionChange);
        editor.commit();
        selectedFragment = new BeanFragment();
